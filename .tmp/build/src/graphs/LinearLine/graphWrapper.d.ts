...
export declare const GraphContainer: import("styled-components").IStyledComponent<"web", {
...
export declare const GraphWrp: import("styled-components").IStyledComponent<"web", {
    ref?: React.LegacyRef<HTMLDivElement>;
    key?: React.Key;
    defaultChecked?: boolean;
    defaultValue?: string | number | readonly string[];
